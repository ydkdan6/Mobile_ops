    ...
    <div class="sidebar">
      <nav class="mt-2">
        ...
        <?php if($_SESSION['login_type'] == 1): ?>
          ...
          <li class="nav-item">
            <a href="#" class="nav-link nav-is-tree nav-edit_poll nav-view_poll">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="./index.php?page=new_poll" class="nav-link nav-new_poll tree-item">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p>Add New</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="./index.php?page=poll_list" class="nav-link nav-poll_list tree-item">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p>List</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            <a href="./index.php?page=poll_report" class="nav-link nav-poll_report">
        ...
        <?php else: ?>
          <li class="nav-item">
            <a href="./index.php?page=poll_widget" class="nav-link nav-poll_widget nav-answer_poll">
