		...
		<div class="card-body">
			<form action="" id="manage_poll">
				...
				<div class="col-lg-12 text-right justify-content-center d-flex">
					...
					<button class="btn btn-secondary" type="button" onclick="location.href = 'index.php?page=poll_list'">Cancel</button>
				</div>
			</form>
		</div>
	</div>
...
<script>
	$('#manage_poll').submit(function(e){
		e.preventDefault()
		$('input').removeClass("border-danger")
		start_load()
		$('#msg').html('')
		$.ajax({
			url:'ajax.php?action=save_poll',
			...
			success:function(resp){
				if(resp == 1){
					...
					setTimeout(function(){
						location.replace('index.php?page=poll_list')
					},1500)
				}
			}
		})
