	...
	<div class="row">
		...
		<div class="col-md-8">
			<div class="card card-outline card-success">
				<div class="card-header">
					<h3 class="card-title"><b>Drop Your Poll Question: </b></h3>
				</div>
				<form action="" id="manage-poll">
				...
				<div class="card-footer border-top border-success">
					<div class="d-flex w-100 justify-content-center">
						<button class="btn btn-sm btn-flat bg-gradient-primary mx-1" form="manage-poll">Submit Answer</button>
						<button class="btn btn-sm btn-flat bg-gradient-secondary mx-1" type="button" onclick="location.href = 'index.php?page=poll_widget'">Cancel</button>
					</div>
				</div>
			</div>
		</div>
