...
<div class="col-lg-12">
	...
	<div class="row">
		<?php 
		$poll = $conn->query("SELECT * FROM poll_set order by rand() ");
              ...
              <div class="card-body" style="display: block;">
               ...
               <div class="row">
               	...
               	<div class="d-flex justify-content-center w-100 text-center">
               			<a href="index.php?page=view_poll_report&id=<?php echo $row['id'] ?>" class="btn btn-sm bg-gradient-primary"><i class="fa fa-poll"></i> View Report</a>
               	</div>
               </div>
              </div>
            </div>
